/* **************************************************************************
 ** Filename: sl_ccm_symptom_classification_report.js
 ** 
 ** CCM Symptom/Classification Report JS Functionality
 **
...
$(document).ready(function() {
	...
	$('#reset-button').click(function(){
		...
		var validator = jQuery('#ccm-symptom-classification-report-form').validate();			/* remove any validation errors */ 
		validator.resetForm();
