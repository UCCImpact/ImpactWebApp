/* **************************************************************************
 ** Filename: sl_ccm_demographic_report.js
 ** 
 ** CCM Demographic Report JS Functionality
 **
...
$(document).ready(function() {
	...
	$('#reset-button').click(function(){
		...
		var validator = jQuery('#ccm-demographic-report-form').validate();			/* remove any validation errors */ 
		validator.resetForm();
...
$(document).ready(function () {
	...
	$('#cccm-demographic-report-form').validate({
		rules: {
			"patientId": {
				required: false,
				digits: true
